...
public class CartServiceImpl implements CartService {
	...
	private float fetchPrice(String productId,Throwable t) {
	Product product=new Product(productId,"Dummy",0,"A dummy product");
			System.out.println("Reponse from fallback");
